...
def call_device_by_hook(vid, pid, hostIp, busIp, func, *args, **kwargs):
    """
    ...
    c1 = ctypes.c_char_p(vid.encode())
    c2 = ctypes.c_char_p(pid.encode())
    host = ctypes.c_char_p(hostIp.encode())
    usb_p = ctypes.c_char_p(busIp.encode())
